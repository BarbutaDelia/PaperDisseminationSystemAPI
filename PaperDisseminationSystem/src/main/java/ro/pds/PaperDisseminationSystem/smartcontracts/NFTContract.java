...
public class NFTContract extends Contract {
    ...
    public static List<NFTMintedEventResponse> getNFTMintedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(NFTMINTED_EVENT, transactionReceipt);
